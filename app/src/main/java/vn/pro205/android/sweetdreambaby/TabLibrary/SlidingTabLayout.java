package vn.pro205.android.sweetdreambaby.TabLibrary;

/**
 * Created by Minh Color on 8/28/2015.
 */
...
import internship.minhcolor.trainingmaterialdesign.ControlFragmentActivity;
 ...
 * <p>
 * The colors can be customized in tab2 ways. The first and simplest is to provide an array of colors
...
public class SlidingTabLayout extends HorizontalScrollView {
     ...
     * circular array. Providing tab1 color will mean that all tabs are indicated with the same color.
     */
    ...
    private void populateTabStrip() {
        ...
        final ControlFragmentActivity.MyPagerAdapter adapter = (ControlFragmentActivity.MyPagerAdapter) mViewPager.getAdapter();
    ...
    public void setTabsBackgroundColorResource(int color) {
